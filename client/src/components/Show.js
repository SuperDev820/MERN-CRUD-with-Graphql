...
function Show(props) {
    return (
        <Query pollInterval={500} query={GET_BOOK} variables={{ bookId: props.match.params.id }}>
            {({ loading, error, data }) => {
                    ...
                    <div className="container">
                        <div className="panel panel-default">
                            ...
                            <div className="panel-body">
                                ...
                                <Mutation mutation={DELETE_BOOK} key={data.book._id} onCompleted={() => props.history.push("/")}>
